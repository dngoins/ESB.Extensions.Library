...
namespace ESB.Extensions.Library.AdapterProviders.ACTIVEDIRECTORY
{
    /// <summary>
    ...
    /// </summary>
    public class ACTIVEDIRECTORYAdapterProvider : BaseAdapterProvider
    {
        ...
        public override string AdapterContextPropertyNamespace
        {
            get
            {
                ...
                //Taken from the Esb.Extensions.Schemas project

                return "https://ESB.Extensions.Schemas.psActiveDirectory";
